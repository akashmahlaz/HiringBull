...
const inputTv = tv({
  slots: {
    ...
    input:
      'mt-0 font-inter text-base font-medium leading-5 text-neutral-900 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white',
  },
  ...
  variants: {
    ...
    disabled: {
      true: {
        input: 'bg-neutral-200 dark:bg-neutral-800',
      },
    },
  },
  defaultVariants: {
...
export const Input = React.forwardRef<NTextInput, NInputProps>((props, ref) => {
  ...
  return (
    <View>
      ...
      <View
        className={`flex-row items-center border-[0.5px] border-neutral-200 p-2 px-4 dark:border-neutral-700 dark:bg-neutral-800 ${
          isSearch ? 'rounded-full bg-slate-50' : 'rounded-xl bg-white'
        }`}
      >
        <NTextInput
          testID={testID}
        ...
        {isSearch && (
          <Ionicons
            name="search-outline"
            size={20}
            color={isDark ? colors.neutral[300] : colors.neutral[900]}
          />
        )}
      </View>
      {error && (
