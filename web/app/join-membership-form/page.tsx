...
const social1 = '/social1.png';
const social2 = '/social2.png';
const membershipGoldCoin = '/membership-gold-coin.gif';
...
const JoinMembershipForm = () => {
  ...
  useEffect(() => {
    loadRazorpay().catch((error) => console.error(error));
  }, []);
  ...
  const handleNextPage2 = async () => {
    ...
    try {
      ...
      setMainError(err?.message || "Failed to submit application. Please try again.");
    } finally {
      setIsSubmitting(false);
    }
  };
  ...
  const handleReferralClick = async () => {
    ...
    try {
      const res = await fetch(
        `${API_BASE_URL}/api/public/referral/${formData.referralEmail}`
      );
                    ...
                    <div className="options">
                      ...
                      <label>
                        <input
                          ...
                          name="reason"
                          value="other"
                          checked={formData.reasonOption === "other"}
                          onChange={handleChange("reasonOption")}
                        />
                        <div className="text">
